...
9. 新实体首次出现是否写清楚（名字/身份/记忆点）；如需手动标注（可选）：使用隐藏 XML 标签（见 `/Users/dongliang04/Documents/个人/小说/女频/.claude/skills/webnovel-query/references/tag-specification.md`）
